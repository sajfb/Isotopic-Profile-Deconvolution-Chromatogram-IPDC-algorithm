%% To create a folder containing of compounds that have at least one record in comptox for one ionization pathway
% clear;clc
...
for i=1:size(Final_Candidates,1)
    if ~isempty(Final_Candidates{i,Column_xlx(1)})
