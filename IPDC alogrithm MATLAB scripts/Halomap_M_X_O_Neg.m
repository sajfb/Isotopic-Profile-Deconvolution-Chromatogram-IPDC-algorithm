...
EntireKnownMolFormula={{'C12Cl10';'C12HCl9';'C12H2Cl8';'C12H3Cl7';'C12H4Cl6';'C12H5Cl5';'C12H6Cl4';'C12H7Cl3';'C12H8Cl2';'C12H9Cl'},'PCB',[1 0 0],'square';
    ...
    {'C12Cl8O';'C12HCl7O';'C12H2Cl6O';'C12H3Cl5O';'C12H4Cl4O';'C12H5Cl3O';'C12H6Cl2O';'C12H6ClO'},'PCDE [M-H-Cl_2+O]^-',[0 0 1],'square';
    {'C12Cl8O2';'C12HCl7O2';'C12H2Cl6O2';'C12H3Cl5O2';'C12H4Cl4O2';'C12H5Cl3O2';'C12H6Cl2O2';'C12H7ClO2'},'PCB [M-H-Cl+O_2]^-',[0 1 0],'square';
    {'C12Br10O';'C12HBr9O';'C12H2Br8O';'C12H3Br7O';'C12H4Br6O';'C12H5Br5O';'C12H6Br4O';'C12H7Br3O';'C12H8Br2O';'C12H9BrO'},'PBDE','cyan','o';
    {'C12Br8O';'C12HBr7O';'C12H2Br6O';'C12H3Br5O';'C12H4Br4O';'C12H6Br2O';'C12H7BrO'},'PBDE [M-H-Br_2+O]^-',[0 0.498039215803146 0],'o';
    ...
    {'C14H7Cl3';'C14H8Cl2'},'DDE fragments',[0 0.498039215803146 0],'diamond';
    {'C10H5Cl7O'},'Heptachlor Epoxide',[0 0 0],'s';
    {'C14H9Cl3'},'DDMU',[0 0 0],'d';
    {'C10H5Cl7'},'Heptachlor',[0 0 0],'v';
    {'C10H6Cl8'},'Chlordane',[0 0 0],'>';
    {'C10H5Cl9'},'Nonachlor',[0 0 0],'h';
    {'C10H4Cl8O'},'Oxychlordane',[0 0 0],'o';
...
L=[];
knownmasses=[478.70866,  408.78957, 374.82855, 340.86753, 306.90651, 270.94844, 236.98742, 494.70357, 460.74255, 424.78448, 390.82346, 356.86244, 322.90142, 286.94335, 422.76882, 388.8078, 354.84678, 320.88576, 284.92769, 438.76373, 404.80271, 370.84169, 336.88067, 300.9226, 266.96158, 894.24668, 816.33617, 736.42771, 658.5172, 578.60874, 500.69823, 420.78977, 380.87553, 424.77896, 358.77391, 324.81289, 290.85187, 264.83621, 260.88576, 224.92769, 190.96667, 382.77391, 348.81289, 314.85187, 280.89085, 244.93278, 484.82089, 450.85987, 416.89885, 382.93783, 346.97976, 310.92808, 334.93783, 261.03188, 296.9641, 368.83912, 263.00308];   % background masses due to PCB overloading
...
for k=1:size(EntireKnownMolFormula,1)
    for n_f=1:2     % n_f represent the number of ionization pathways
        ...
        if ~isempty(K_H)
            if n_f==1 && k~=3 && k~=4 && k~=6
                DP=[EntireKnownMolFormula{k,2},'  [M-X+O]^-'];
